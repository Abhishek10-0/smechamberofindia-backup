...
//    
//    echo "<script type='text/javascript'> window.location.href='subscribe-newsletter.php?captchaError=true&title=".$_POST['title']."&fname=".$_POST['fname']."&lname=".$_POST['lname']."&designation=".$_POST['designation']."&companyname=".$_POST['companyname']."&businessactivity=".$_POST['businessactivity']."&businessinterest=".$_POST['businessinterest']."&mobilenumber=".$_POST['mobilenumber']."&phonenumber=".$_POST['phonenumber']."&email=".$_POST['email']."&address=".$_POST['address']."';</script>";
...
$title = $fname = $lname= $designation = $companyname = $businessactivity = $businessinterest = $phonenumber = $mobilenumber = $email = $address = "";
$to = "director@smechamber.com";
$sub = "SME Chamber Newsletter";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST['fname'])) {
        ...
        $designation = $_POST['fname'];
    }
      if (empty($_POST['lname'])) {
        $error = "Please Enter Your Last Name";
    } else {
        $designation = $_POST['lname'];
    }
    ...
    if (empty($_POST['businessactivity'])) {
      ...
      if (empty($_POST['businessinterest'])) {
        ...
        $businessactivity = $_POST['businessinterest'];
    }
    ...
    if (empty($_POST['phonenumber'])) {
        $error = "Please Enter Office number";
    } else {
        $phonenumber = $_POST['phonenumber'];
    }
...
$fnlmsg1 = "$title $fname $lname $designation $companyname $businessactivity $businessinterest $phonenumber $mobilenumber $email $address";
...
ob_start();
include './newsletter-composemsg.php';
$message = ob_get_clean();
if (empty($error)) {

    $headers = 'MIME-Version: 1.0' . "\r\n";
    $headers = 'From: Sme Chamber of India Newsletter Subscribe' . "\r\n";
    ...
    echo "<script type='text/javascript'>alert('$error'); window.location.href='subscribe-newsletter.php';</script>";
}
?>