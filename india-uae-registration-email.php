...
$sub = "Register name For INDIA - UAE Business Summit Event";
...
ob_start();
include './india-uae-registration-compose.php';
...
// mail($to, $sub, " Name : $name\n E-mail : $email\n Message : $msg");
    ...
    echo "<script type='text/javascript'>alert('$error'); window.location.href='india-uae-registration.php';</script>";
}
?>