...
<html>
    <head>
        <meta charset="utf-8">
        <title>INDIA - UAE Business Summit | SME Chamber of India</title>
...
<!--                    <li>Register For Event</li>-->
                ...
                <section class="membership-form" >
                    <div class="container" >
                        <div class="row-fluid">
                            <form action="india-uae-registration-email.php" method="post" id="mform" class="member-form" >
                                <div class="panel-main-standard panel-form">
                                    <h1>Registration for INDIA - UAE Business & Investment Summit</h1>
