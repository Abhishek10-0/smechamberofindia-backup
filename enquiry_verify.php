...
curl_setopt_array($curl, array(
			  CURLOPT_URL => "http://103.211.202.40/sendsms/bulksms_v2.php?apikey=c21lY2htOmlXejVvYkJD&type=TEXT&sender=SMECHM&entityId=1201158099447823312&mobile=$mobileNumber1&message=Thank%20you%20for%20registering%20with%20us.%20We%20will%20contact%20you%20shortly-SMECHM",
			  CURLOPT_RETURNTRANSFER => true,
			  CURLOPT_ENCODING => "",
			  CURLOPT_MAXREDIRS => 10,
			  CURLOPT_TIMEOUT => 30,
...
/* Create connection */
$sql = "INSERT INTO enquiry_form (f_name, l_name, designation, company_name, email, mobilenumber, message) VALUES 
('$f_name', '$l_name', '$designation','$companyname', '$email','$mobilenumber', '$message')";

if ($conn->query($sql) === TRUE) {
	
# FIX: Replace this email with recipient email
		# Sender Data
        $subject = "Enquiry Form | SME Chamber of India";
                                  ...
                                  <p>Fields marked with a <span class="emp">*</span> are required.</p><br>
									<form action="" method="post">
									  <div class="form-group">
										...
										<span>Did not receive OTP? <a href="enquiry_verify.php?do=resend">Resend</a></span>
									  </div>
