...
<html>
    <head>
        <title>Global Investment Immigration Summit | Ahmedabad</title>
    ...
    <body>
        <div class="container">
            ...
            <img src="http://smechamberofindia.com/global/giis-ahmedabad.jpg" alt="Global Immigration & Investment Summit - Ahmedabad" class="res">
            ...
            <form action="giis-ahme-em.php" method="POST">
                <fieldset>
                ...
                <fieldset>
                    <div class="row">
                        ...
                        <div class="col-75">
                            ...
                            <input type="checkbox" name="profession" value="Other"><label style="color: black;">Other </label>
                        </div>
                    </div>
                </fieldset>
                <fieldset>
                ...
                <fieldset>
                    <div class="row">
                        ...
                        <div class="col-75">
                            ...
                            <input type="checkbox" name="check_list[]" value="Malta"><label style="color: black;">Malta</label>
                            <input type="checkbox" name="check_list[]" value="Cyprus"><label style="color: black;">Cyprus</label>
                            <input type="checkbox" name="check_list[]" value="Australia"><label style="color: black;">Australia</label>    
                            <input type="checkbox" name="check_list[]" value="New Zealand"><label style="color: black;">New Zealand</label>
                            <input type="checkbox" name="check_list[]" value="Latvia"><label style="color: black;">Latvia</label>
                            <input type="checkbox" name="check_list[]" value="Bulgaria"><label style="color: black;">Bulgaria</label>
                            <input type="checkbox" name="check_list[]" value="Portugal"><label style="color: black;">Portugal</label>
                            <input type="checkbox" name="check_list[]" value="Grenada"><label style="color: black;">Grenada</label>    
                            <input type="checkbox" name="check_list[]" value="St Lucia"><label style="color: black;">St Lucia </label>
                            <input type="checkbox" name="check_list[]" value="St Kitts and Nevis"><label style="color: black;">St Kitts and Nevis</label>
                            <input type="checkbox" name="check_list[]" value="Antigua and Barbuda"><label style="color: black;">Antigua and Barbuda </label>
