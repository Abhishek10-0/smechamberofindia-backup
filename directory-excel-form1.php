...
<!-- End Facebook Pixel Code -->
            ...
            <div id="main">
                <div id="banner" style="height: 75px;">
                    <div id="inner-banner">
                        <div class="container">
                            <div class="row-fluid">
                                <h1 style="text-transform: capitalize;">Add your name in India SME Directory</h1>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="span10" style="box-shadow: 0 0 15px rgba(0, 0, 0, 0.1); padding: 25px ">
     <h1 style="text-align:center;">Add your name in India SME Directory</h1>
      <form method="post" action=""  class="form" enctype = "multipart/form-data">
        ...
        <div class="column">
          ...
          <div class="input-box">
            ...
            <input type="text" name="mobilenumber" id="mobilenumber" placeholder="Mobile No*." maxlength="10" minlength="10" onkeypress="return isNumber(event)" title="Please enter exactly 10 digits" required value="<?php echo isset($_GET['mobilenumber']) ? $_GET['mobilenumber'] : "" ?>">
          </div>
        </div>
        ...
        <div class="gender-box">
          ...
          <div class="gender-option">
            ...
            <div class="gender">
             <input name="businesssector[]" type="checkbox" id="businesssector" value="Textiles">
        ...
        <h3 style="font-weight:600;">Turnover of Company for last 3 years (in Rs. Cr) </h3>
         <div class="column">
          ...
          <div class="input-box">
            <label>2022 - 2023 <span class="emp">*</span></label>
          ...
          <div class="gender-option">
           <div class="gender" >
            ...
            <input name="Looking_for_support[]" type="checkbox" id="Looking for support" value="Service providers "><label for="Service providers ">Service providers </label>
             ...
             <div class="gender">
            <input name="Looking_for_support[]" type="checkbox" id="Looking for support" value="Marketing"><label for="Service providers ">Marketing</label>
             </div>
             <div class="gender">
            <input name="Looking_for_support[]" type="checkbox" id="Looking for support" value="Branding"><label for="Branding">Branding</label>
             </div>
             <div class="gender">
            <input name="Looking_for_support[]" type="checkbox" id="Looking for support" value="Promotion"><label for="Service providers ">Promotion</label>
             </div>            
          </div>
        </div>
