            ...
            <div id="main">
                <div id="banner" style="height: 75px;">
                    <div id="inner-banner">
                        <div class="container">
                            <div class="row-fluid">
                                <h1>Contact for INDIA - GCC BUSINESS & INVESTMENT SUMMIT</h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <h2 style="text-align: center;"><u>Saakshi Kulkarni - Director</u></h2>
                    <p style="text-align: center; margin-bottom: 2%; margin-top: 5px;">
                        <b>Email:<a href="mailto:skulkarni@smechamber.com">skulkarni@smechamber.com</a></b><br>
                        <b>TEL: +91 - 22 -61509800</b><br>
                        <b>Mobile: +91 - 8291879068 </b>
                    </p>
                </div>
               </div>
