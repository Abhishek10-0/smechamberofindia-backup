...
<div style="font: normal 14px Arial, Helvetica, sans-serif; color: #000; text-align: center; margin: 10px 0; border-bottom: 2px solid #999; padding-bottom: 10px;">
    <span><b style="color: #250990; font-size: 1.1em;">Event Date: </b> <?php echo $row["event_day"] ?> <?php echo $row["event_month"] ?> 
	<b style="font-size: 1.5em;"> | </b> <b style="color: #250990; font-size: 1.1em;">Time: </b><?php echo $row["event_time"] ?>  <b style="font-size: 1.5em;"> | 
	</b><b style="color: #250990; font-size: 1.1em;">Event Venue: </b><?php echo $row["event_place"] ?>  <b style="font-size: 1.5em;"> | </b> <b style="color: #250990; font-size: 1.1em;">Registration Form: 
	</b><?php echo $row["reg_form"] ?> 
</span> 
</div>
