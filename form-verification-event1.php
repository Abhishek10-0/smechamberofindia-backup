...
# FIX: Replace this email with recipient email
        ...
        $lookingsupport = trim($_SESSION["lookingsupport"]);
        ...
        $content .= "Looking for Support from Chamber: $lookingsupport\n";
        ...
        if ($success) {
            ...
            $_SESSION["successMSG"] = "Thank you Registering for Events Alert.";
