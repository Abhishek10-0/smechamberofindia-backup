...
$_SESSION['otp']=$rndno;
header( "Location: enquiry_verify.php" );
}
} else {}
...
<html>
    <head>
        <meta charset="utf-8">
        <title>Enquiry Form | SME Chamber Of India</title>
        <meta name="keywords" content="Enquiry Form, Enquiry , SME Chamber of India, MSME">
        <meta name="description" content="Enquiry Form, Enquiry , SME Chamber of India, MSME">
...
<!-- End Facebook Pixel Code -->
            ...
            <div id="main">
                <div id="banner" style="height: 75px;">
                    <div id="inner-banner">
                        <div class="container">
                            <div class="row-fluid">
                                <h1 style="text-transform: capitalize;">Enquiry Form</h1>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  <div class="span10" style="box-shadow: 0 0 15px rgba(0, 0, 0, 0.1); padding: 25px ">
     <h1 style="text-align:center; font-weight: 800;"><u>Enquiry Form</u></h1>
    ...
    <div class="column">
          ...
          <input name="companyname" type="text" id="companyname" placeholder="Company Name" class="text" required="" value="">
          </div>
          <div class="input-box">
            <label class="control-label" for="Designation">Designation <span class="emp">*</span></label>
          <input name="designation" type="text" id="designation" placeholder="Designation" class="text" required="" value="">
      </div>
        </div>
        ...
        <div class="column">
          <div class="input-box">
            ...
            <input type="text" name="mobilenumber" id="mobilenumber" placeholder="Mobile No*." maxlength="10" minlength="10" onkeypress="return isNumber(event)" title="Please enter exactly 10 digits" required="" value="">
          </div>
          <div class="input-box">
          <label>Email Address <span class="emp">*</span></label>
          <input name="email" type="email" class="text" placeholder="Enter Email Id" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required="" value="" style="width: 90%;">
        </div>
        </div>
    ...
    <div class="input-box">
          <label>Enquiry <span class="emp">*</span></label>
          <textarea name="message" class="text" rows="3" placeholder="Enquiry" required="" style="width: 97%;"></textarea>
        </div>
    
        
    <button type="submit" value="Submit" name="add_name">Submit</button>
      </form>
    </div>
    </div>
  </section>
