...
<!-- End Facebook Pixel Code -->
            ...
            <div id="main">
                <div id="banner" style="height: 75px;">
                    <div id="inner-banner">
                        <div class="container">
                            <div class="row-fluid">
                                <h1 style="text-transform: capitalize;">Subscribe to our Newsletter!</h1>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  <div class="span10" style="box-shadow: 0 0 15px rgba(0, 0, 0, 0.1); padding: 25px; margin-top: 40px; ">
     <h1 style="text-align:center;">Subscribe to our Newsletter!</h1>
      <form method="post" action=""  class="form" enctype = "multipart/form-data">
    
     <div class="column">
          <div class="input-box">
            <label class="control-label" >Name <span class="emp">*</span></label>
          <input name="name" type="text" id="name" class="text" placeholder="Name" required value="<?php echo isset($_GET['name']) ? $_GET['name'] : "" ?>">
          </div>
        ...
        <div class="column">
          ...
          <input name="company_name" type="text" id="name" class="text" placeholder="Company Name" required value="<?php echo isset($_GET['company_name']) ? $_GET['company_name'] : "" ?>">
        </div>
        </div>
        ...
        <div class="column">
          ...
          <input name="designation" type="text" id="name" class="text" placeholder="Designation" required value="<?php echo isset($_GET['designation']) ? $_GET['designation'] : "" ?>">
        </div>
        </div>
