...
# FIX: Replace this email with recipient email
		# Sender Data
        $subject = "SME Chamber of India $form_name Enquiry";
...
<html>
    <head>
        <meta charset="utf-8">
        <title>Form Verification | SME Chamber of India</title>
                                  ...
                                  <p>Fields marked with a <span class="emp">*</span> are required.</p><br>
									<form action="" method="post">
									  <div class="form-group">
										...
										<span>Did not receive OTP? <a href="form-verification.php?do=resend">Resend</a></span>
									  </div>
