...
$sub = "Sponsorship For INDIA - GCC Business Summit Event";
...
ob_start();
include './india-gcc-sponsorship-compose.php';
$message = ob_get_clean();
if (empty($error)) {
    
         echo '<script>';
     $url = 'download-india-gcc-business-summit.php';
     $headers = 'MIME-Version: 1.0' . "\r\n";
    $headers = 'From: click on INDIA - GCC BUSINESS & INVESTMENT SUMMIT ' . "\r\n";
  ...
  echo "window.open('$url');".PHP_EOL;
    ...
    echo "<script type='text/javascript'>alert('$error'); window.location.href='india-gcc-sponsorship.php';</script>";
}
?>