...
# FIX: Replace this email with recipient email
        # Sender Data
        $subject = "India SME Leadership Council | SME Chamber of India";
        ...
        $interest = trim($_SESSION["interest"]);
        ...
        $sectorsme = trim($_SESSION["sectorsme"]);
        ...
        $content .= "Business Interest: $interest\n\n";
        $content .= "Detail Of Products & Services to promote amongst SMEs: $service\n\n";
        $content .= "Business Sectors of SMEs: $sectorsme\n\n";
        ...
        if ($success) {
            ...
            $_SESSION["successMSG"] = "Thank you for showing interest as India SME Leadership Council. We will send the proposal shortly.";
            header( "Location: success_leadership.php" );
        } else {
...
<html>
  <head>
    <meta charset="utf-8">
    <title>India SME Leadership Council Otp Verify </title>
                ...
                <h1>OTP Verfication</h1>
                  ...
                  <form action="" method="post">
                    <div class="form-group">
                      ...
                      <span>Did not receive OTP? <a href="form-verify_leadership.php?do=resend">Resend</a></span>
                    </div>
