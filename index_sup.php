...
<span aria-hidden="true">&times;</span>
  ...
  <a href="https://smeevents.in/Mailers/SBF_APR.php" target="blank">
<img  src="https://smeevents.in/Mailers/images/SBF_APR.jpg"  width="500" /></a>   
  
 
</div>
<div class="mySlides1 fade1">
  
  <a href="https://smeevents.in/Mailers/SMES_APR-24.php" target="blank">
<img  src="https://smeevents.in/Mailers/images/SMES_APR-24.jpg"  width="500" /></a>   
...
<div class="mySlides1 fade1">
  ...
  <a href="https://smeevents.in/Mailers/SMES_APR.php" target="blank">
<img  src="https://smeevents.in/Mailers/images/SMES_APR.jpg"  width="500" /></a>   
...
<div class="mySlides1 fade1">
  ...
  <a href="https://bit.ly/3UfmPC8" target="blank">
<img  src="https://smeevents.in/Mailers/images/SMEM-Thane.jpeg"  width="500" /></a>   
...
<div class="mySlides1 fade1">
  ...
  <a href="https://www.gtreview.com/events/asia/gtr-india-2024-mumbai/#tab_book" target="blank">
<img  src="https://smeevents.in/Mailers/images/GTR-India-2024-1.jpg"  width="500" /></a>   
...
?>
            <div id="main">
                <div id="banner">
                    <div id="imgGallary">
                        <ul id="home-banner">
                            <li> <img src="images/slider images/banner-3.jpg" alt="img" ></li>
                            <li> <img src="images/slider images/banner-2.jpg" alt="img" ></li>
					...
					<div class="row-fluid">
                        <div class="col-md-12 col-md-offset-1" >
                            <h2 style="padding-top: 3%; font: 300 24px/24px 'Roboto Slab', serif; text-align: center; text-transform: uppercase; ">About Us</h2>
								...
								development of SMEs from manufacturing, service sectors and allied industrial / business sectors for the last <?php echo $year; ?> years. The Chamber integrates SMEs, large 
				...
				<section class="partners-section" id="forthcoming">
                    <div class="container">
                        <div class="row-fluid">
                            <div class="button-box" style="text-align: center; padding-left: 3%;">
                                <div class="colors-btn" style="margin-top: 30px;">
                                    <a class="btn-small color-10">Forthcoming Event</a>
                                </div>
                            </div>
						  <div class="col-md-4 " style="padding-left: 0px; text-align: center;">
						         <a href="https://bit.ly/49BQfPb" target="_blank">
                                        <img src="images/channel-partners/SMES_APR-24-1.jpg"  style="border: 1px solid #0088cc;">
                                    </a>
						  </div>

						  <div class="col-md-4 " style="padding-left: 0px; text-align: center;">
						  <a href="https://smeevents.in/Mailers/SMES_APR.php" target="_blank">
                                        <img src="images/channel-partners/SMES_APR-1.jpg" style="border: 1px solid #0088cc;">
                                    </a>
						  </div>
						  
						  <div class="col-md-3 " style="padding-left: 0px; text-align: center;">
						   <a href="https://www.gtreview.com/events/asia/gtr-india-2024-mumbai/#tab_book" target="_blank">
                                        <img src="images/channel-partners/GTR1.jpg" style="border: 1px solid #0088cc;">
                                    </a>
						  </div>
                ...
                <section class="partners-section" id="Divisions">
                    ...
                    <div class="container">
					 ...
					 <div class="col-md-6 Support" style="padding-left: 0px; ">
                           <div class="button-box" style="text-align: center; padding-left: 3%">
                                <div class="colors-btn">
							 ...
							 <ul class="partners-slider">
								...
								<li>
								   <a href="https://www.smechamberofindia.com/support1.php?id=41" target="_blank" >
                                        <img src="Supported_Events/IFS2.gif" alt="IFS" >
                                    </a>
								</li>
								...
								<li>
								   <a href="https://www.smechamberofindia.com/support1.php?id=43" target="_blank" >
                                        <img src="Supported_Events/IWE1.gif" alt="IWE" >
                                    </a>
								</li>
							  
							
							    <li> 
								   <a href="https://www.smechamberofindia.com/support1.php?id=44" target="_blank" >
                                        <img src="Supported_Events/PVE_Banner.jpg" alt="PVE Banner" >
                                    </a>
								</li>
								 <li>
								   <a href="https://www.smechamberofindia.com/support1.php?id=45" target="_blank" >
                                        <img src="Supported_Events/MFE.gif" alt="MFE" >
                                    </a>
								</li>
								
								 <li>
								   <a href="https://www.smechamberofindia.com/support1.php?id=49" target="_blank" >
                                        <img src="Supported_Events/IMTS.jpg" alt="IMTS" >
                                    </a>
								</li>
					 ...
					 <div class="col-md-6 Support" style="padding-left: 0px; ">
                         <div class="button-box" style="text-align: center; padding-left: 3%">
                             ...
                             <ul class="partners-slider">
							    ...
							    <!--<li>
								   <a href="https://www.smechamberofindia.com/support1.php?id=46" target="_blank" >
                                        <img src="Supported_Events/MIAMI-Expo.jpg" alt="MIAMI Expo" >
                                    </a>
								</li>-->
								
								<li>
								   <a href="https://www.smechamberofindia.com/support1.php?id=47" target="_blank" >
				...
				<section class="contact-page">
                    <div class="container">
					 ...
					 <div class="row" style="margin-left: 0px;">
					 <div class="col-md-6 member" style="padding-left: 0px; ">
                           <div class="button-box" style="text-align: center; padding-left: 3%">
                                <div class="colors-btn">
                        ...
                        <div class="col-md-6 col-md-offset-1 member1 member" ">
                            <div class="button-box" style="text-align: center; padding-left: 3%">
                                <div class="colors-btn">
                            ...
                            <ul class="partners-slider">
							   ...
							   <li>
								   <a href="https://www.adititoolings.co.in/" target="_blank" >
							   ...
							   <li>
								   <a href="https://srinilink.com/" target="_blank" >
                                        <img src="images/members/SRINILINK.jpg" alt="SRiNi LiNK team" >
                                    </a>
								</li>
							    ...
							    <li>
								   <a href="https://anmglobal.net/" target="_blank" >
                                        <img src="images/members/ANM_global.jpg" alt="ANM Global" >
                                    </a>
								</li>
				 ...
				 <!--<section class="contact-page"> date- 26-03-2024
                    <div class="container">
					<div class="row-fluid">
					  <div class="col-md-2 col-md-offset-1" >
					  </div>
                        <div class="col-md-7 col-md-offset-1" >
						<a href="https://bit.ly/3SvbI7j" target="blank">
                         <img src="https://www.smechamberofindia.com/images/SupHub-H.jpg">
                          </a>     
