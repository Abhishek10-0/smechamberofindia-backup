        ...
        <div id="wrapper"> 
            ...
            <div id="main">
                ...
                <section class="membership-form" >
                    <div class="container" >
                        <div class="row-fluid">
                            <form method="post" action="DownloadMembershipformemail.php"  id="mform" class="member-form" >
...
<!--                                    <input type="checkbox" name="information" value="<?php echo isset($_GET['information']) ? $_GET['information'] : "" ?>"> Event Alerts <b>|</b>
                                    ...
                                    <div class="form">
                                        ...
                                        <div class="field">
                                            <label class="control-label" for="Name">Name <span class="emp">*</span></label>
                                            <div class="controls">
                                                <input name="fname" type="text" id="fname" class="text" value="<?php echo isset($_GET['fname']) ? $_GET['fname'] : "" ?>" required>
                                            </div>
                                        </div>
                                        <div class="field">
