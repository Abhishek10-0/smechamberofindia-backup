...
# FIX: Replace this email with recipient email
		# Sender Data
        $subject = "Channel Partner Enquiry | SME Chamber of India";
        ...
        if ($success) {
            ...
            $_SESSION["successMSG"] = "Thank you for showing interest as Channel Partner. We will send the proposal shortly.";
                                  ...
                                  <p>Fields marked with a <span class="emp">*</span> are required.</p><br>
									<form action="" method="post">
									  <div class="form-group">
										...
										<span>Did not receive OTP? <a href="form-verification-channel-partner.php?do=resend">Resend</a></span>
									  </div>
