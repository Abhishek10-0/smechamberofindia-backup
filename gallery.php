...
<html>
  <head>
    <meta charset="utf-8">
    <title>Gallery | SME Chamber of India</title>
            ...
            <section class="about-page gallery">				
              <div class="container" >
                ...
                <?php
                  ...
                  <div class="span3">
                    <p>
                      <img class="fancybox" src="images/PhotoGallery/Small/<?php echo $row1["gallery-image"]; ?>.jpg" 
										  data-big="images/PhotoGallery/Big/<?php echo $row1["gallery-image"]; ?>.jpg" 
										  title="<?php echo $row1["gallery_image_content"] ?>">
                    </p>
                    <br>                  
                  </div>
                <?php
