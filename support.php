...
<html>
  <head>
    <meta charset="utf-8">
    <title>Supporting Events | SME Chamber of India</title>
        ...
        <div class="container">
          ...
          <div class="row-fluid">
            <div class="span12">
              <section class="block block__events">
                <div class="tab-content">
                  <div id="smechamberconference" class="tab-pane fade in active">
                    <?php
                      $sql = "SELECT * from supp_ev WHERE status = 1 ORDER BY event_date ASC";
                      ...
                      <div class="event__col event__single">
                        ...
                        <div class="event__content">
                          <span class="event__title"><a href="support1.php?id=<?php echo $row["ide"] ?>"><?php echo $row["event_name"] ?></a></span> 
                          <!--<span class="event__title"><b onclick="javascript:div_show_detail('<?php echo $row["ide"] ?>')" style="color: #0088cc;"><?php echo $row["event_name"] ?></b></span>-->
              ...
              <!--<div class="span12">
                <a href="https://meaiindia.com/Cybersecurity_Conclave/" target="blank"> 
                  <img src="https:///smeevents.in/Mailers/2026/JUNE/BG_AICS.jpg">
                </a>
              </div>-->
            </div>
          </div>
