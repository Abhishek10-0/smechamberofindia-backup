...
<div class='popup1'>
          ...
          <div class="row-fluid">
            <div class="col-md-12 ">                       
              <div class="button-box" style="text-align: center; ">
                ...
                <p style="text-align: justify; font: 400 14px/22px 'Open Sans', sans-serif;">
          ...
          <div class="container">
            <div class="row-fluid">
              <div class="col-md-12">
                <div class="button-box" style="text-align: center; ">
                  <div class="home-premium-title-wrapper" style="margin-top: 30px;">
                    <h2><a class="home-premium-title">strategic Partners</a></h2>
                  </div>
                </div>
              </div>
              <div class="col-md-12" style="padding-left: 9%;">
    ...
    <a href="javascript:void(0);" id="policyLink">
		...
		<section class="bottom-banner-section" style="padding: 40px 0;">
  <div class="container">
    <div class="row-fluid">
      <div class="col-md-12">
    ...
    <section >
        <div class="container">
         ...
         <div class="row-fluid" style="margin-left:0; display:flex; justify-content:center; align-items:flex-start; flex-wrap:wrap; gap:20px;">
    ...
    <div class="container">
      <div class="row-fluid">
        ...
        <div class="row" style="margin-left: 0px;">
          <div class="col-md-6 member span6" style="padding-left: 0px; ">
            <div class="button-box" style="text-align: center; ">
              <div class="home-premium-title-wrapper">
            ...
            <div class="col-md-6 col-md-offset-1 member1 member span6" >
