...
$title = $fname = $lname= $designation = $companyname  = $mobilenumber = $email = $interest = $captcha = "";
$to = "director@smechamber.com";
$sub = "Register name For INDIA - GCC Business Summit Event";
...
$fnlmsg1 = "$title $fname $lname $designation $companyname $mobilenumber $email $interest";
...
ob_start();
include './india-gcc-registration-compose.php';
$message = ob_get_clean();
if (empty($error)) {

// mail($to, $sub, " Name : $name\n E-mail : $email\n Message : $msg");
    $headers = 'MIME-Version: 1.0' . "\r\n";
    $headers = 'From: Sme Chamber of India For Event Registration' . "\r\n";
    ...
    echo "<script type='text/javascript'>alert('$error'); window.location.href='india-gcc-registration.php';</script>";
}
?>