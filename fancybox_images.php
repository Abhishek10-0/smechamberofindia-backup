                            ...
                            if ($result1->num_rows > 0) {
                                ...
                                while ($row1 = $result1->fetch_assoc()) {
                                    ?>
                                        ...
                                        <div class="col-lg-3 column hover-zoomin">
                                            <a data-caption="<?php echo $row1["gallery_image_content"] ?>"
                                               data-fancybox="gallery"
                                               href="images/PhotoGallery/Small/<?php echo $row1["gallery-image"]; ?>.jpg">
                                              <img class="rounded" src="images/PhotoGallery/Small/<?php echo $row1["gallery-image"]; ?>.jpg" />
                                            </a>
                                        </div>
