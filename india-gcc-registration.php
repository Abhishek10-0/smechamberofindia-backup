...
<html>
    <head>
        <meta charset="utf-8">
        <title>INDIA - GCC Business Summit | SME Chamber of India</title>
            ...
            <div id="main">
                <div id="banner" style="height: 75px;">
                    <div id="inner-banner">
                        <div class="container">
                            <div class="row-fluid">
                                <h1 style="text-transform: capitalize;">INDIA - GCC BUSINESS & INVESTMENT SUMMIT</h1>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--                    <li>Register For Event</li>-->
                ...
                <section class="membership-form" >
                    <div class="container" >
                        <div class="row-fluid">
                            <form action="india-gcc-registration-email.php" method="post" id="mform" class="member-form" >
                                <div class="panel-main-standard panel-form">
                                    <h1>Registration for INDIA - GCC Business & Investment Summit</h1>
                                    ...
                                    <div class="form">
                                        ...
                                        <div class="field">
                                            <label class="control-label" for="Interest">Interest <span class="emp">*</span></label>
                                            <div class="controls">
