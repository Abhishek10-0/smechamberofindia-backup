        ...
        <div id="wrapper"> 
            ...
            <div id="main">
                ...
                <section class="membership-form" >
                    <div class="container" >
                        <div class="row-fluid">
                            <form method="post" action="newsletter-email.php"  id="mform" class="member-form" >
                                <div class="panel-main-standard panel-form">

                                    <h1>We won’t spam you, Don’t worry.</h1>
                                    ...
                                    <div class="form">
                                        ...
                                        <div class="field">
                                            ...
                                            document.getElementById('title').value = "<?php echo $_GET['title'];?>";
                                                ...
                                                <input name="fname" type="text" id="fname" class="text" placeholder="first name" style="width:209px;" value="<?php echo isset($_GET['fname']) ? $_GET['fname'] : "" ?>"/>
                                                <input name="lname" type="text" id="lname" class="text" placeholder="last name" style="width:209px;" value="<?php echo isset($_GET['lname']) ? $_GET['lname'] : "" ?>"/>
                                            </div>
                                        </div>
                                        <div class="field">
                                            <label class="control-label" for="Designation">Designation <span class="emp">*</span></label>
                                            <div class="controls">
                                                <input name="designation" type="text" id="designation" class="text" value="<?php echo isset($_GET['designation']) ? $_GET['designation'] : "" ?>"/>
                                            </div>
                                        </div>
                                        <div class="field">
                                            <label class="control-label" for="Company Name">Company Name <span class="emp">*</span></label>
                                            <div class="controls">
                                                <input name="companyname" type="text" id="companyname" class="text" value="<?php echo isset($_GET['companyname']) ? $_GET['companyname'] : "" ?>"/>
                                            </div>
                                        </div>
                                        <div class="field">
                                            <label class="control-label" for="Business Activity">Business Activity <span class="emp">*</span></label>
                                            <div class="controls">
                                                <input name="businessactivity" type="text" id="businessactivity" class="text" value="<?php echo isset($_GET['businessactivity']) ? $_GET['businessactivity'] : "" ?>"/>
                                            </div>
                                        </div>
                                        <div class="field">
                                            <label class="control-label" for="Business Interest">Business Interest <span class="emp">*</span></label>
                                            <div class="controls">
                                                <input name="businessinterest" type="text" id="businessinterest" class="text" value="<?php echo isset($_GET['businessinterest']) ? $_GET['businessinterest'] : "" ?>"/>
                                            </div>
                                        </div>
                                        <div class="field">
                                            <label class="control-label" for="Contact Detail">Contact Detail: <span class="emp">*</span></label>
                                            <div class="controls">
                                                <input type="text" name="mobilenumber" id="mobilenumber" placeholder="Mobile No." style="width:253px;" maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits" value="<?php echo isset($_GET['mobilenumber']) ? $_GET['mobilenumber'] : "" ?>"/>
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="controls">
                                                <input name="email" type="email" id="email" class="text" value="<?php echo isset($_GET['email']) ? $_GET['email'] : "" ?>"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="controls">
                                                <input name="address" type="text" id="address" class="text" value="<?php echo isset($_GET['address']) ? $_GET['address'] : "" ?>"/>
                                            </div>
                                        </div>
