...
$sub = "Register name For Speaking Opportunity in INDIA - GCC Business Summit Event";
...
ob_start();
include './india-gcc-speaking-compose.php';
...
// mail($to, $sub, " Name : $name\n E-mail : $email\n Message : $msg");
    ...
    echo "<script type='text/javascript'>alert('$error'); window.location.href='india-gcc-speaking.php';</script>";
}
?>