            ...
            <div id="main">
                <div id="banner" style="height: 75px;">
                    <div id="inner-banner">
                        <div class="container">
                            <div class="row-fluid">
                                <h1 style="text-transform: capitalize;">Entrepreneurship Development Council</h1>
                            </div>
                        </div>
                    </div>
                </div>
                <ul class="breadcrumb">
                    ...
                    <li>Entrepreneurship Development Council</li>
                </ul>
                <section class="about-page">
                    <div class="container">
                        <p style="text-align:center">
                            <img src="https://www.smechamberofindia.com/images/EDC.jpg" width="800">
							</p>
                    </div>
                </section>
