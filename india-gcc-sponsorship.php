...
<html>
    <head>
        <meta charset="utf-8">
        <title>INDIA - GCC Business & Investment Summit | SME Chamber of India</title>
...
<!--                    <li>Register For Event</li>-->
                ...
                <section class="membership-form" >
                    <div class="container" >
                        <div class="row-fluid">
                            <form action="india-gcc-sponsorship-email.php" method="post" id="mform" class="member-form" >
                                <div class="panel-main-standard panel-form">
                                    <h1>Register for Sponsorship Opportunities </h1>
