...
if ($err) {
  $errMSGs = "Error :" . $err;
    ...
    $topic=$_SESSION['topic'];
      ...
      $sql = "INSERT INTO discussion (f_name, l_name, email, phone, designation, company_name, business_activity, city, state, topic) VALUES ('$f_name', '$l_name', '$email','$phone', '$designation', '$company_name', '$business_activity', '$city', '$state', '$topic')";
        
        if ($conn->query($sql) === TRUE) {
          # FIX: Replace this email with recipient email
          # Sender Data
          $subject = "Call For Discussion - SME Chamber of Indian";
          ...
          # email headers.
          $headers = "From: Call For Discussion - SME Chamber of India <no-reply@smechamberofindia.com>" . "\r\n";
