...
/* Create connection */
$sql = "INSERT INTO enquiry_form (title, f_name, l_name, designation, company_name, department, email, mobilenumber, city, Nature_of_work) VALUES 
('$title','$f_name', '$l_name', '$designation','$companyname','$department', '$email','$mobilenumber', '$city', '$address')";

if ($conn->query($sql) === TRUE) {
	
# FIX: Replace this email with recipient email
		# Sender Data
        $subject = "Contact Us For Any Enquiry | smechamberofindia.com";
                                  ...
                                  <p>Fields marked with a <span class="emp">*</span> are required.</p><br>
									<form action="" method="post">
									  <div class="form-group">
										...
										<span>Did not receive OTP? <a href="contact-us-email1.php?do=resend">Resend</a></span>
									  </div>
