...
table, td {
    ...
    <body>                  
        ...
        <tr>
            ...
            <tr>
                <td><strong>Details of Consultancy Services to promote amongst SMEs:</strong></td>
                <td><label><?php echo $_SESSION['service'] ?></label>
                </td>
            </tr>
            <tr>
                <td><strong>Business Sectors of SMEs:</strong></td>
                <td><label><?php echo $_SESSION['sector'] ?></label>
                </td>
            </tr>
            <tr>
