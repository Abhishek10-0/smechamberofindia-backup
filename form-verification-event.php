...
# FIX: Replace this email with recipient email
		# Sender Data
        $subject = "Register For Event Alert | SME Chamber of India";
		...
		$content .= "Company_Name: $companyname \n\n";
        $content .= "Business_Sector: $businesssector \n\n";
        $content .= "Email: $email \n\n";
        $content .= "Contact_Detail: $mobilenumber \n\n";
		...
		$sql = "INSERT INTO event_alert (title,fname, lname, designation, cname, businesssector, email, mobile, city, state)
        VALUES ('$title','$fname','$lname','$designation', '$companyname', '$businesssector', '$email', '$mobilenumber', '$city','$state')";
        ...
        if ($success) {
            ...
            $_SESSION["successMSG"] = "Thank you Registering for Business and Event Alerts.";
                                  ...
                                  <p>Fields marked with a <span class="emp">*</span> are required.</p><br>
									<form action="" method="post">
									  <div class="form-group">
										...
										<span>Did not receive OTP? <a href="form-verification-event.php?do=resend">Resend</a></span>
									  </div>
