...
<html>
<head>
<title>Invitation Attend Hong Kong Business Seminar in Mumbai</title>
...
<img src="http://worldexindia.com/emailers/2019/HKTDC/HKTDC_Logo_2.png" style="position: absolute;top: 50px;left: 120px;" width="80px" /><br />
<h2 style="font-family: Helvetica Neue,Helvetica,Arial,sans-serif;  font-size:22px; margin-bottom:10px; line-height:24px;">
<span style="font-size:20px; text-align: justify;"><b>Invitation</b> <br>"Hong Kong Business Seminar in Mumbai"</span></h2>
<h3 style="font-size:16px; margin-top:0px; line-height:20px;">
<span style="font-size:16px;">On Thursday, 24th January 2019<br />
JW Marriott Mumbai Sahar.</span></h3>
<p><a href="http://smechamberofindia.com" target="_blank" >
<img src="http://smechamberofindia.com/SME-chamber-of-india.jpg" style="float: right; margin-top: -100px; margin-right: 50px;" width="180px" />
</a>
</p>
</div>
...
<form action="HKTDC-em.php" class="register form-horizontal" method="POST">
...
<label for="Interested Products/Services" class="col-sm-2 control-label">Interested Products/Services:</label>
<div class="col-sm-3">
