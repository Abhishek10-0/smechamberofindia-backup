...
//    
//    echo "<script type='text/javascript'> window.location.href='sme-consultants.php?captchaError=true&title=".$_POST['title']."&fname=".$_POST['fname']."&lname=".$_POST['lname']."&designation=".$_POST['designation']."&companyname=".$_POST['companyname']."&businessactivity=".$_POST['businessactivity']."&businesssector=".$_POST['businesssector']."&businessinterest=".$_POST['businessinterest']."&service=".$_POST['service']."&sector=".$_POST['sector']."&mobilenumber=".$_POST['mobilenumber']."&phonenumber=".$_POST['phonenumber']."&email=".$_POST['email']."&address=".$_POST['address']."';</script>";
...
$title = $fname = $lname = $designation = $companyname = $businessactivity = $businesssector = $businessinterest = $service = $sector = $mobilenumber = $phonenumber = $email = $address = "";
$to = "director@smechamber.com";
$sub = "Request to add In SME Consultant";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST['businessinterest'])) {
        $error = "Please Enter Business Interest";
    } else {
        $businessinterest = $_POST['businessinterest'];
    }
    if (empty($_POST['service'])) {
        $error = "Please Enter Details of Consultancy Services to promote amongst SMEs";
    } else {
        $service = $_POST['service'];
    }
...
$fnlmsg1 = "$title $fname $lname $designation $companyname $businessactivity $businesssector $businessinterest $service $sector $mobilenumber $phonenumber $email $address";
...
ob_start();
include './consultant-composemsg.php';
$message = ob_get_clean();
if (empty($error)) {

    $headers = 'MIME-Version: 1.0' . "\r\n";
    $headers = 'From: SME Chamber of India Consultant Form' . "\r\n";
    ...
    echo "<script type='text/javascript'>alert('$error'); window.location.href='sme_consultants.php';</script>";
}
?>