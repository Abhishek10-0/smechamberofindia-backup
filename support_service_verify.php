...
# FIX: Replace this email with recipient email
		# Sender Data
        $subject = "REQUEST FOR SUPPORT SERVICES | SME Chamber of India";
        ...
        $industrial = trim($_SESSION["industrial"]); 
        ...
        $services = trim($_SESSION["services"]);
		$tell = trim($_SESSION["tell"]);
        $tell1 = trim($_SESSION["tell1"]);
		$tell2 = $tell." ".$tell1;
        ...
        $content .= "Email: $email \n";
        $content .= "Contact Detail: $phone \n";
        $content .= "Address: $city, $state \n";
        $content .= "Designation: $designation \n";
        $content .= "Company Name: $companyname \n";
        $content .= "Industrial / Business Sector: $industrial \n";
		$content .= "Interested to avail following services: $services \n";
	    $content .= "Consent: $category \n";
		...
		$sql = "INSERT INTO support_service (f_name, l_name, designation, company_name, Industrial_Business_Sector, category, email, phone, city, state, services, How_you_know) 
VALUES ('$fname', '$lname', '$designation', '$companyname','$industrial', '$category', '$email','$phone', '$city', '$state', '$services', '$tell2')";
...
# FIX: Replace this email with recipient email
 ...
 if ($conn->query($sql) === TRUE){	    
        ...
        if ($success) {
            ...
            $_SESSION["successMSG"] = "Thank you Registering for Support Service - SME Chamber of India.";
			header( "Location: support_service_success.php" );
        } else {
...
<html>
  <head>
    <meta charset="utf-8">
    <title>Support Service Verify | SME Chamber of India</title>
      ...
      <div id="main">
        <div id="banner" style="height: 75px;">
          <div id="inner-banner">
            <div class="container">
              <div class="row-fluid">
                <h1>Support Service Verification</h1>
              </div>
            </div>
          </div>
        </div>
                ...
                <p>Fields marked with a <span class="emp">*</span> are required.</p><br>
									<form action="" method="post">
									  <div class="form-group">
  										...
  										<span>Did not receive OTP? <a href="support_service_verify.php?do=resend">Resend</a></span>
									  </div>
