...
<html>
    <head>
        ...
        <meta name="description" content="Business Enquiry In SME Chamber Of India , BUSINESS ENQUIRY , Enquiry About Business">
                            ...
                            <form method="post" action="business-enquiry-email.php"  id="mform" class="member-form" >
                                <div class="panel-main-standard panel-form">
                                    ...
                                    <div class="form">
                                        ...
                                        <div class="field">
                                            <label class="control-label" for="Business Enquiry">Business Enquiry<span class="emp">*</span></label>
                                            <div class="controls">
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="controls">
                                                <input name="email" type="email" id="email" class="text" required value="<?php echo isset($_GET['email']) ? $_GET['email'] : "" ?>">
                                            </div>
                                        </div>
                                        <div class="field">
