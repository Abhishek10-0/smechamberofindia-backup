...
$_SESSION['otp']=$rndno;
header( "Location: contact-us-email1.php" );
}
} else {}
                ...
                <ul class="breadcrumb">
					...
					<section class="membership-form" >
                        ...
                        document.getElementById('title').value = "<?php echo $_GET['title'];?>";
                                            ...
                                            <div class="field">
                                                <label class="control-label" for="Department">Department <span class="emp">*</span></label>
                                                <div class="controls">
                                                   <input name="department" type="text" id="department" class="text" required value="<?php echo isset($_GET['department']) ? $_GET['department'] : "" ?>">
                                            ...
                                            <div class="field">
                                                <label class="control-label" for="Address">Nature of work: <span class="emp">*</span></label>
                                                <div class="controls">
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="controls">
													...
													<input type="text" class="form-control" name="mobilenumber" placeholder="add 91 before 10 digit number" maxlength="12"  style="width:253px;"
													minlength="12" pattern="\d{12}$" title="Please enter exactly 12 digits" onkeypress="return isNumber(event)" required>
